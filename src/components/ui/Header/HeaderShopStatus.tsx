  ...
  return (
    <div className=''>
      <div className='h-6 flex items-center gap-[46px] rounded-[15px] px-3 py-0.5 bg-[#A9A9A9] sm:h-[26px]'>
        ...
        />
        <Item type='busy' setStatus={setStatus} isActive={status === 'busy'} />
        <Item type='open' setStatus={setStatus} isActive={status === 'open'} />
      </div>
      <div
        className={cn(
...
const Item: FC<IItem> = ({ type, isActive, setStatus }) => {
  return (
    <div
